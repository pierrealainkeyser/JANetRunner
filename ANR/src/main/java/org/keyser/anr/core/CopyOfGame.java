...
import org.keyser.anr.core.runner.RunnerOld.UseIceBreakerAbility;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class CopyOfGame implements Notifier, ConfigurableEventListener {
	...
	private static final Logger log = LoggerFactory.getLogger(CopyOfGame.class);
	...
	private final RunnerOld runner;

	private GameStep step;

	private int turn = 0;

	public Game(RunnerOld runner, Corp corp, ConfigurableEventListener delegated, Flow end) {
		this.runner = runner;
		this.corp = corp;
	...
	public CopyOfGame(RunnerOld runner, Corp corp, Flow end) {
