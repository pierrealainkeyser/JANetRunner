...
public class ObjectMapperFactoryBean implements FactoryBean<ObjectMapper> {
	 ...
	 * 
	 */
	// public static class BreakCostAnalysisSerializer extends
	// SerializerBase<BreakCostAnalysis> {
	// public BreakCostAnalysisSerializer() {
	// super(BreakCostAnalysis.class, true);
	// }
	//
	// @Override
	// public void serialize(BreakCostAnalysis value, JsonGenerator jgen,
	// SerializerProvider provider) throws IOException, JsonGenerationException
	// {
	//
	// jgen.writeStartObject();
	//
	// JsonSerializer<Object> jsc = provider.findValueSerializer(Cost.class,
	// null);
	//
	...
	public static class CostSerializer extends SerializerBase<Cost> {
		...
		public void serialize(Cost value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonGenerationException {
			...
			//
			// String costLine =
			// alls.stream().collect(Collectors.joining(" + "));
